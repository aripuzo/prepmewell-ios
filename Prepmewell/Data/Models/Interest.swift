...
struct Interest: Codable {
    let recordNo: Int
    let studentInterest, studyExpectingYear, subject, studyDestination: String?
    let isIELTS, isTOEFL, isTOEIC, isUMAT, isGED, isUKCAT, isGCE, isSAT, isACT, isGAMSAT, isLSAT, isMAT, isGRE, isGMAT, isMCAT, isDAT, isOAT, isPCAT, isTEAS, isAHPAT: Bool?
    let currentEducation, currentInstitution, currentProgramme, averageScore, intendingToWork, isGottenAJob, careerPath, isCertificationToWork, relocation, isEligibleForRelocation, isNeedConsultation, createdOn: String?
    let tef, wes, ices, iqas, pebc, ces, icas, mcc: Bool?
    let twoOrMoreDegrees, whatIsYourFamilySize, whatIsJobTitle: String?
    let interestFk, studentFk, yearsOfExperience: Int?
